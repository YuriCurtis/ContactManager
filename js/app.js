...
config(['$routeProvider', function ($routeProvider) {
	...
	/*$routeProvider.when('/contacts/add', {templateUrl: 'partials/contact-add.html', controller: 'contactAddCtrl'});*/
	$routeProvider.when('/contacts/edit', {templateUrl: 'partials/contact-edit.html', controller: 'contactEditCtrl'});
